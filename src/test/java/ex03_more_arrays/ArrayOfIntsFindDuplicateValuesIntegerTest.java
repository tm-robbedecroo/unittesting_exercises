...
class ArrayOfIntsFindDuplicateValuesIntegerTest {

        @Test
        void findDuplicateValues_happyflow() {
            ArrayOfInts aoi = new ArrayOfInts();
            Integer[] result = aoi.findDuplicateValuesInteger(new Integer[] {1, 1, 4, 1, 5, 4});

            assertArrayEquals(new Integer[] {1, 4}, result);
        }

        @Test
        void findDuplicateValues_paranoia() {
            ArrayOfInts aoi = new ArrayOfInts();
            Integer[] result = aoi.findDuplicateValuesInteger(new Integer[] {1, 1, 4, 1, 5, null, 1, null, 5, 4});
